...
import { UnCustomerEntryService } from './uncustomer-entry.service';

@Component({
  selector: 'app-uncustomer-entry',
  templateUrl: './uncustomer-entry.component.html',
  styleUrls: ['./uncustomer-entry.component.scss']
})

export class UnCustomerEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: UnCustomerEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<UnCustomerEntryComponent>,
