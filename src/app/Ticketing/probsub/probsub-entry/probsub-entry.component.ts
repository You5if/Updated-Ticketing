...
import { ProbSubEntryService } from './probsub-entry.service';

@Component({
  selector: 'app-probsub-entry',
  templateUrl: './probsub-entry.component.html',
  styleUrls: ['./probsub-entry.component.scss']
})

export class ProbSubEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: ProbSubEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<ProbSubEntryComponent>,
