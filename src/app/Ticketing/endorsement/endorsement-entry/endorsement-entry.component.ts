...
import { EndorsementEntryService } from './endorsement-entry.service';

@Component({
  selector: 'app-endorsement-entry',
  templateUrl: './endorsement-entry.component.html',
  styleUrls: ['./endorsement-entry.component.scss']
})

export class EndorsementEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: EndorsementEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<EndorsementEntryComponent>,
