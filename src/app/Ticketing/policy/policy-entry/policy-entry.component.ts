...
import { PolicyEntryService } from './policy-entry.service';

@Component({
  selector: 'app-policy-entry',
  templateUrl: './policy-entry.component.html',
  styleUrls: ['./policy-entry.component.scss']
})
...
export class PolicyEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PolicyEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PolicyEntryComponent>,
