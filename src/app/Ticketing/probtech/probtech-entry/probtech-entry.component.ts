...
import { ProbTechEntryService } from './probtech-entry.service';

@Component({
  selector: 'app-probtech-entry',
  templateUrl: './probtech-entry.component.html',
  styleUrls: ['./probtech-entry.component.scss']
})

export class ProbTechEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: ProbTechEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<ProbTechEntryComponent>,
