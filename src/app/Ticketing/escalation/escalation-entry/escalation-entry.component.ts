...
import { EscalationEntryService } from './escalation-entry.service';
import { MatDialogRef, MAT_DIALOG_DATA } from '@angular/material/dialog';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-escalation-entry',
  templateUrl: './escalation-entry.component.html',
  styleUrls: ['./escalation-entry.component.scss']
})

export class EscalationEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: EscalationEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<EscalationEntryComponent>,
