...
import { ProblemCatEntryService } from './problemcat-entry.service';

@Component({
  selector: 'app-problemcat-entry',
  templateUrl: './problemcat-entry.component.html',
  styleUrls: ['./problemcat-entry.component.scss']
})

export class ProblemCatEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: ProblemCatEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<ProblemCatEntryComponent>,
