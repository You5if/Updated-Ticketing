...
import { ProbAgentEntryService } from './probagent-entry.service';

@Component({
  selector: 'app-probagent-entry',
  templateUrl: './probagent-entry.component.html',
  styleUrls: ['./probagent-entry.component.scss']
})

export class ProbAgentEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: ProbAgentEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<ProbAgentEntryComponent>,
