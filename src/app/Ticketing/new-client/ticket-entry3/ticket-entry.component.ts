...
export class TicketEntry3Component implements OnInit {
  ...
  constructor(
      ...
      private dialogRef: MatDialogRef<TicketEntry3Component>,
  ...
  ngOnInit() {
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      ...
      this.dapiService.Controllers(this.pModel.model).subscribe(res => {
        ...
        this.data[1].value = '0'
        this.data[5].value = "Type: " + this.pModel.typeName+ " \nDesc:" + this.pModel.descName
        this.data[6].value = "Customer: " + this.pModel.number  +" \nName:" + localStorage.getItem(this._globals.baseAppName + '_clientName') + " \nContact:" + this.pModel.number  +"\nContact2: \nPolicyCode: " + this.pModel.codeName
