...
import { TicketCloseEntryService } from './ticketclose-entry.service';

import { Direction } from '@angular/cdk/bidi';
@Component({
  selector: 'app-ticketclose-entry',
  templateUrl: './ticketclose-entry.component.html',
  styleUrls: ['./ticketclose-entry.component.scss']
})

export class AdminTicketCloseEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: TicketCloseEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<AdminTicketCloseEntryComponent>,
  ...
  ngOnInit() {
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      ...
      this.dapiService.Controllers(this.pModel.dataRe).subscribe(res => {
        ...
        this.data[1].value = this.pModel.tick.ticketId
