...
import { AdminUploadFiles3Component } from "./upload-files/upload-files.component";
...
@Component({
  selector: "app-admin-card-upload",
  templateUrl: "./upload.component.html",
  styleUrls: ["./upload.component.scss"]
})
export class AdminUploadCardComponent implements OnInit {
  // step.2
  ...
  @ViewChild(AdminUploadFiles3Component) childFileListComponent: AdminUploadFiles3Component;
