...
import { UnDepartmentEntryService } from './undepartment-entry.service';

@Component({
  selector: 'app-undepartment-entry',
  templateUrl: './undepartment-entry.component.html',
  styleUrls: ['./undepartment-entry.component.scss']
})

export class UnDepartmentEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: UnDepartmentEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<UnDepartmentEntryComponent>,
